      ...
      <nav className="absolute top-5 left-[50%] translate-x-[-50%] w-[95%] sm:w-[85%] h-14 rounded-3xl z-500 bg-white flex items-center justify-between shadow px-2 ">
        ...
        >
          <CustomLink target="categories/test" title="دسته بندی">
            <>
              <FaAngleDown className="text-primary absolute -left-5 top-3 hidden lg:block hover:" />
              <ul className="absolute top-10  gap-2 rounded-3xl  -left-60 z-100 w-[320px] flex-wrap min-h-[140px] max-h-[400px] overflow-y-auto  bg-white  border-t border-primary  hidden lg:group-hover:flex items-center justify-between p-2 ">
                <Category
